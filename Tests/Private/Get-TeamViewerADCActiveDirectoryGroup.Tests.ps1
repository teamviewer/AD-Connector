BeforeAll {
    . "$PSScriptRoot\..\..\Cmdlets\Private\Get-TeamViewerADCActiveDirectoryGroup.ps1"
}

Describe 'Get-TeamViewerADCActiveDirectoryGroup' {
    It 'declares correct output type' {
        $CommandInfo = Get-Command -Name Get-TeamViewerADCActiveDirectoryGroup
    ...
    It 'returns an empty array when no groups are found' {
        ...
        $Result = Get-TeamViewerADCActiveDirectoryGroup -AD_Root 'LDAP://DC=example,DC=com'
    ...
    It 'assigns AD_Root to the DirectorySearcher search root' {
        ...
        Get-TeamViewerADCActiveDirectoryGroup -AD_Root 'LDAP://DC=example,DC=com'
    ...
    It 'passes the Limit parameter to DirectorySearcher.SizeLimit' {
        ...
        Get-TeamViewerADCActiveDirectoryGroup -AD_Root 'LDAP://DC=example,DC=com' -Limit 5000
    ...
    It 'rejects a negative Limit' {
        { Get-TeamViewerADCActiveDirectoryGroup -AD_Root 'LDAP://DC=example,DC=com' -Limit -1 -ErrorAction Stop } | Should -Throw
    }
}
