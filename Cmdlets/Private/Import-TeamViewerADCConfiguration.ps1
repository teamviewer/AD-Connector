function Import-TeamViewerADCConfiguration {
    [CmdletBinding()]
    ...
    if (Test-Path -Path $Config_File -PathType Leaf) {
        ...
        $Config_Default.Keys | Where-Object { !$Configuration.PSObject.Properties[$_] } | ForEach-Object { $Configuration | Add-Member $_ $Config_Default[$_] }
    }
    else {
        $Configuration = New-Object PSObject -Prop $Config_Default
    }
