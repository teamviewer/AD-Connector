...
- Converters map API fields to PascalCase properties, assign the existing `TeamViewerADC.*` type name, and emit the typed object. Parse optional dates defensively.
...
- For public behavior changes, update the dedicated help file, `Docs/TeamViewerADC.md`, and `CHANGELOG.md` when user-visible.
